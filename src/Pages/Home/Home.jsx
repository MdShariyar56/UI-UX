...
const Home = () => {
    ...
    useEffect(() => {
        const img = new Image();
        img.src = 'https://i.ibb.co/VY5dshYJ/Group-34.png';
            ...
            <div className="flex flex-col md:flex-row md:space-x-6 items-center max-w-6xl w-full px-4 mt-10">
                ...
                <div className="flex-1 lg:px-4 text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center lg:justify-start gap-3 mt-3">
                        <div className="flex gap-2 justify-center lg:justify-start mt-3">
                            <a href="https://www.behance.net/eng-tuhin000" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[#00d9ff] hover:bg-blue-500 transition-colors duration-300">
                                <FontAwesomeIcon icon={faBehance} className="w-7 h-7 p-2 text-black hover:text-white" />
                            </a>
                            <a href="mailto:youremail@example.com" className="p-2 rounded-full bg-[#00d9ff] hover:bg-blue-500 transition-colors duration-300 flex items-center justify-center">
                                <Mail className="w-9 h-7 text-black hover:text-white" />
                            </a>
                            <a href="#" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-[#00d9ff] hover:bg-blue-500 transition-colors duration-300">
                ...
                <div className="flex-1 mt-8 md:mt-5 flex justify-center md:justify-end">
                    <img
                        ...
                        alt="Shariyar Kobir"
                        className="w-80 sm:w-96 h-auto rounded-full transition-transform duration-300 hover:scale-105"
                    />
                </div>
            </div>
        </section>
